...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">添加角色<small></small></h1>
<!-- end page-header -->
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            ...
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" action="<?php echo site_url('backend/role/addRoleDo');?>" method="post">
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4" for="fullname">角色 * :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" id="rolename" name="rolename" placeholder="必填" data-parsley-required="true" required/>
                        </div>
                    </div>
                    <div class="form-group">
