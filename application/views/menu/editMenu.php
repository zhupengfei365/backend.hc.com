...
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">编辑导航<small></small></h1>
<!-- end page-header -->
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">编辑导航</h4>
            </div>
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" action="<?php echo site_url('backend/menu/editMenuDo') . '/' . $data['id'];?>" method="post">
                    <?php if($data['p_id'] != 0) {?>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="default-select2 form-control" name="p_id">
                                ...
                                <option <?php if($data['p_id'] == $m['id']) { echo "selected";}?> value="<?=$m['id']?>"><?= $m['title']?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input class="form-control" type="text" id="title" name="title" value="<?=$data['title']?>" placeholder="Required" data-parsley-required="true" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input class="form-control" type="text" id="icon_name" name="icon_name" value="<?=$data['icon_name']?>" placeholder="" data-parsley-required="true"/>
                        </div>
                    </div>
                    <?php if($data['p_id'] != 0) {?>
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="default-select2 form-control" name="node_id">
                                ...
                                <option <?php if($data['id'] == $n['id']) { echo "selected";}?> value="<?=$n['id']?>"><?= $n['dirc'] . '/' . $n['cont'] . '/' . $n['func']?></option>
                                <?php endforeach;?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input class="form-control" type="text" id="sort" name="sort" data-parsley-type="" value="<?=$data['sort']?>" placeholder="" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <div class="radio">
                                <label>
                                    <input type="radio" name="status" value="1" id="radio-required" <?php if($data['status'] == 1) echo "checked='checked'";?> data-parsley-required="true" /> 启用
                                </label>
                            </div>
                            <div class="radio">
                                <label>
                                    <input type="radio" name="status" id="radio-required2" <?php if($data['status'] == 0) echo "checked='checked'";?>  value="0" /> 停用
                                </label>
                            </div>
                        </div>
                    </div>
