...
<ol class="breadcrumb pull-right">
    ...
    <li class="active">规格编辑</li>
</ol>
<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">规格编辑<small></small></h1>
<!-- end page-header -->
    ...
    <div class="col-md-12">
        ...
        <div class="panel panel-inverse" data-sortable-id="form-validation-1">
            <div class="panel-heading">
                ...
                <h4 class="panel-title">规格编辑</h4>
            </div>
            <div class="panel-body panel-form">
                <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" action="<?php echo site_url('backend/spec/editSpecDo');?>" method="post">
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4" for="spec_name">规格名 * :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" id="spec_name" name="spec_name" value="<?=$info['name']?>" placeholder="必填" data-parsley-required="true" required/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" id="remark" name="remark" value="<?=$info['remark']?>" placeholder="必填" data-parsley-required="true" required/>
                        </div>
                    </div>
<!--                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6" id="spec_value_div">
                            ...
                            <div class="form-inline">
                                ...
                                <input type="hidden" name="spec_value_id[]" value="<?= $v['spec_value_id']?>">
                                <?php if($k==0) {?>
...
<script type="text/javascript">
    $('#add_spec_btn').click(function(){
        var input = '<div class="form-inline m-t-5"><input class="form-control" type="text" id="spec_value_name" name="spec_value_name[]" value="" placeholder="必填" required> <a href="javascript:;" id="add_spec_btn" class="btn btn-danger m-r-5 fa fa-times" onclick="delDivDom(this)"></a></div>';
