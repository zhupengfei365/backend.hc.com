                ...
                <form class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form" action="<?php echo site_url('backend/role/editNodeDo') . '/' . $id;?>" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" id="dirc" name="dirc" value="<?=$dirc?>" readonly="readonly" placeholder="Required" data-parsley-required="true" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" id="cont" name="cont" data-parsley-type="" value="<?=$cont?>" placeholder="" data-parsley-required="true" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4" for="website">方法 * :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" id="func" name="func" data-parsley-type="" value="<?=$func?>" placeholder="" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-4 col-sm-4" for="website">描述 * :</label>
                        <div class="col-md-6 col-sm-6">
                            <input class="form-control" type="text" id="memo" name="memo" data-parsley-type="" value="<?=$memo?>" placeholder="" required/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="radio">
                                <label>
                                    <input type="radio" name="status" id="radio-required2" <?php if($status == 0) echo "checked='checked'";?>  value="0" /> 停用
                                </label>
                            </div>
                        </div>
                    </div>
