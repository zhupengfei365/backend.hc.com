...
$config['rbac_auth_gateway']         = 'backend/user/login';    		//默认认证网关
$config['rbac_default_index']        = 'backend/home/index';     //成功登录默认跳转模块
$config['rbac_manage_menu_hidden']   = array('后台管理');        //后台管理导航中不显示的菜单
$config['rbac_manage_node_hidden']   = array('manage');			//后台管理节点中不显示的菜单
$config['rbac_notauth_dirc']         = array('backend/user');	     	//默认无需认证目录array("public","manage")
