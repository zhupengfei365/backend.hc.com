...
<script type="text/javascript">
    $('#add_attr_btn').click(function(){
        var input = '<div class="form-inline m-t-5"><input class="form-control" type="text" id="attr_value_name" name="attr_value_name[]" value="" placeholder="必填" required> <a href="javascript:;" id="add_attr_btn" class="btn btn-danger m-r-5 fa fa-times" onclick="delDivDom(this)"></a></div>';
